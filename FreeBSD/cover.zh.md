...
- CI 镜像位于 {ztmpl}`{{endpoint}}/releases/CI-IMAGES`
- ISO/IMG 镜像位于 {ztmpl}`{{endpoint}}/releases/ISO-IMAGES`
- OCI 镜像位于 {ztmpl}`{{endpoint}}/releases/OCI-IMAGES`
- 虚拟机模板位于 {ztmpl}`{{endpoint}}/releases/VM-IMAGES`
- 文档及资料位于 {ztmpl}`{{endpoint}}/doc`
