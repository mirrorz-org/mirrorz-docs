...
gpg --export '95C0FAF38DB3CCAD0C080A7BDC78B2DDEABC47B7' | {{sudo}} tee /etc/apt/trusted.gpg.d/cran_debian_key.gpg > /dev/null
# Ubuntu 用户添加该公钥
wget -qO- {{endpoint}}/bin/linux/ubuntu/marutter_pubkey.asc | {{sudo}} gpg --dearmor -o /etc/apt/trusted.gpg.d/cran_ubuntu_key.gpg
# 更新软件包
{{sudo}}apt-get update
